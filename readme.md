...
If a keyboard folder has _beta at the end of the name that means it is not part of the official QMK repo yet. Please remember to include _beta in the name when building the firmware, if neccesary.

For example: qmk compile -kb 1upkeyboards/super16v2_beta -km via
